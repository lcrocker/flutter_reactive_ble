...
class NegotiatePhyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NegotiatePhyRequest', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceId', protoName: 'deviceId')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phySize', $pb.PbFieldType.O3, protoName: 'phySize')
    ..hasRequiredFields = false
  ;

  NegotiatePhyRequest._() : super();
  factory NegotiatePhyRequest({
    $core.String? deviceId,
    $core.int? phySize,
  }) {
    final _result = create();
    ...
    if (phySize != null) {
      _result.phySize = phySize;
    }
    return _result;
  }
  factory NegotiatePhyRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NegotiatePhyRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  NegotiatePhyRequest clone() => NegotiatePhyRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NegotiatePhyRequest copyWith(void Function(NegotiatePhyRequest) updates) => super.copyWith((message) => updates(message as NegotiatePhyRequest)) as NegotiatePhyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NegotiatePhyRequest create() => NegotiatePhyRequest._();
  NegotiatePhyRequest createEmptyInstance() => create();
  static $pb.PbList<NegotiatePhyRequest> createRepeated() => $pb.PbList<NegotiatePhyRequest>();
  @$core.pragma('dart2js:noInline')
  static NegotiatePhyRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NegotiatePhyRequest>(create);
  static NegotiatePhyRequest? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.int get phySize => $_getIZ(1);
  @$pb.TagNumber(2)
  set phySize($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasPhySize() => $_has(1);
  @$pb.TagNumber(2)
  void clearPhySize() => clearField(2);
}

class NegotiatePhyInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NegotiatePhyInfo', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceId', protoName: 'deviceId')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phySize', $pb.PbFieldType.O3, protoName: 'phySize')
    ..aOM<GenericFailure>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failure', subBuilder: GenericFailure.create)
    ..hasRequiredFields = false
  ...
  NegotiatePhyInfo._() : super();
  factory NegotiatePhyInfo({
    $core.String? deviceId,
    $core.int? phySize,
    GenericFailure? failure,
  }) {
  ...
  factory NegotiatePhyInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NegotiatePhyInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  NegotiatePhyInfo clone() => NegotiatePhyInfo()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NegotiatePhyInfo copyWith(void Function(NegotiatePhyInfo) updates) => super.copyWith((message) => updates(message as NegotiatePhyInfo)) as NegotiatePhyInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NegotiatePhyInfo create() => NegotiatePhyInfo._();
  NegotiatePhyInfo createEmptyInstance() => create();
  static $pb.PbList<NegotiatePhyInfo> createRepeated() => $pb.PbList<NegotiatePhyInfo>();
  @$core.pragma('dart2js:noInline')
  static NegotiatePhyInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NegotiatePhyInfo>(create);
  static NegotiatePhyInfo? _defaultInstance;
